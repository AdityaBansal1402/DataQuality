...
'''
sys_text_1 = '''
You are an AI assistant that will read through a list of rules and provide corrseponding json to those rules in the format:
eg.
{
  "float": {
    "type": "number",
...
you will only output json in this format and nothing else.
'''
cb1.system(sys_text)
